...
public class ZoomSeekBar extends View {
    ...
    private ValorListener listener;
    ...
    private int escalaMax = 1; // valor máximo visualizado
    private int escalaIni = 0; // origen de la escala
    private int escalaRaya = 60; // cada cuantas unidades una rayas
    private int escalaRayaLarga = 60; // cada cuantas rayas una larga
    ...
    public ZoomSeekBar(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            valMax = a.getInt(R.styleable.ZoomSeekBar_valMax,0);
            escalaMin = a.getInt(R.styleable.ZoomSeekBar_escalaMin,0);
            escalaMax = a.getInt(R.styleable.ZoomSeekBar_escalaMax,1);
            escalaIni = a.getInt(R.styleable.ZoomSeekBar_escalaIni,0);
            escalaRaya = a.getInt(R.styleable.ZoomSeekBar_escalaRaya,6000);
            escalaRayaLarga = a.getInt(R.styleable.ZoomSeekBar_escalaRayaLarga,10);
    ...
    public void setOnValorListener(ValorListener listener) {
    ...
    public void setVal(int val) {
        if (valMin <= val && val <= valMax) {
            this.val = val;
            listener.onValorChanged(this.val);
    ...
    public void setValMin(int valMin) {
        Log.d("AUDIOBOOKS", "VAL MIN: " + valMin);
        valMax = Math.max(valMax, valMin);
        escalaMin = Math.min(escalaMin, valMin);
        escalaMax = Math.max(escalaMax, valMin);
        this.valMin = valMin;
        invalidate();
    }
    ...
    public void setValMax(int valMax) {
        ...
        Log.d("AUDIOBOOKS", "VAL MAX: " + valMax);
        valMax = Math.max(valMax, valMin);
        escalaMin = Math.min(escalaMin, valMin);
        escalaMax = Math.max(escalaMax, valMin);
        this.valMax = valMax;
